...
SPOTIFY_CLIENT_ID = os.getenv("SPOTIFY_CLIENT_ID_KINY")
SPOTIFY_SECRET_ID = os.getenv("SPOTIFY_SECRET_ID_KINY")
SPOTIFY_REFRESH_TOKEN = os.getenv("SPOTIFY_REFRESH_TOKEN_KINY")
